...
@click.option("--one", 'one', type=str, required=False, default=None)
...
def main(doe_path, to_run, one, to_poll, persistent, args=None):
    """Console script for cooperate."""
    if doe_path is not None:
        ...
        cooperate.execute_single(one, persistent=persistent)
